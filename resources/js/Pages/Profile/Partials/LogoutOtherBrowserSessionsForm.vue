    ...
    <jet-action-section>
        ...
        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                Se necessário, você pode sair de todas as outras sessões do navegador em todos os seus dispositivos. Algumas de suas sessões recentes estão listadas abaixo. Se você acha que sua conta foi comprometida, você também deve atualizar sua senha.
            </div>
